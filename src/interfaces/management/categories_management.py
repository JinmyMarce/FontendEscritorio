...
class GestionCategoriasFrame(ctk.CTkFrame):
    ...
    def guardar_categoria(self):
        # Aquí deberías hacer la petición a la API para guardar la categoría
        # Ejemplo:
        # APIHandler.make_request('post', CATEGORIES_ENDPOINTS['create'], data={...})
        pass

    def cargar_categorias(self):
        # Aquí deberías hacer la petición a la API para obtener las categorías
        # Ejemplo:
        # response = APIHandler.make_request('get', CATEGORIES_ENDPOINTS['list'])
